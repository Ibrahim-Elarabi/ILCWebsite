...
namespace ILCWebsite.Areas.Admin.Controllers
{
    ...
    public class AgentHomeController : Controller
    {
        ...
        public AgentHomeController(IUnitOfWork unitOfWork,
        ...
        {
            var lst = _unitOfWork._agentHomeRepo.GetAll();
            var newList = _mapper.Map<List<AgentHomeVM>>(lst);
            return View(newList.ToList());
        }

        public IActionResult Details(int id)
        {
            var productHome = _unitOfWork._agentHomeRepo.FindOne(d=>d.Id == id && d.IsDeleted != true);
            var result = _mapper.Map<AgentHomeVM>(productHome);
            return View(result);
        }
